    ...
    return (
        <div className="memory">
            ...
            <div className="pad-btn">
                                        ...
                                        >
                                            <FormControl>
                                                ...
                                                <TextField
                                                    ...
                                                    id="batch"
                                                    error = {values.batch === ""}
                                                    helperText = {values.batch === "" ? "Batch is required":""}
                                                    name="batch"
                                                    label="Batch"
                                                    variant="outlined"
                                                    margin="normal"
                                                ...
                                                <Stack direction="row" alignItems="center" spacing={2} sx={{
                                                    ...
                                                    <Button variant="contained" component="label">
                                                        Memories (pictures)                                                        <input hidden accept="image/*" multiple type="file" />
                                                    </Button>
                                                    <IconButton color="primary" aria-label="upload picture" component="label">
                                                        <input hidden accept="image/*" type="file"
                                                            onChange={(e) =>
                ...
                <Snackbar open={sucessOpen} autoHideDuration={6000} onClose={() => setSuccess(false)}>
                    <Alert onClose={() => setSuccess(false)} severity="success" sx={{ width: '100%' }}>
                        Submitted Successfully
                    </Alert>
                </Snackbar>
                <Snackbar open={failureOpen} autoHideDuration={6000} onClose={() => setFailure(false)}>
